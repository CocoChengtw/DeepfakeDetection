...
def run_cmd(cmd):
    try:
        result = subprocess.check_output(cmd, shell=True,  stderr = subprocess.STDOUT) #shell = True, executable = "/bin/bash",
    ...
    for i, v in enumerate(dataset_videos):
        ...
        try:
            ...
            if os.path.exists(out_fd_path):
                ...
                #print(f'rm -r {out_fd_path}, res={res}')  #TODO: WATCH OUT!!
...
for dataset in dataset_l:
    ...
    for split in split_lst:
        ...
        # my_meta = pd.read_csv('data/split/'+dataset+'/metadata.csv')
